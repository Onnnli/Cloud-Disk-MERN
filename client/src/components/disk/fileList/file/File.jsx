      ...
      return (
        <div className='file-plate' onClick={() => openDirHandler(file)}>
          ...
          <div className="file-plate__btns">
              {file.type !== 'dir' &&
              <button onClick={(event) => downloadClickHandler(event)} className='file-plate__btn file__download'><img
                src={downloadBtn} alt=""/></button>}
              <button onClick={(event) => deleteClickHandler(event)} className='file-plate__btn file__delete'><img src={deleteBtn}
                                                                                                             alt=""/>
              </button>
          </div>
    ...
    if(fileView === 'list') {
      return (
        <div className='file' onClick={() => openDirHandler(file)}>
          ...
          {file.type !== 'dir' &&
          <button onClick={(event) => downloadClickHandler(event)} className='file__btn file__download'><img
            src={downloadBtn} alt=""/></button>}
          <button onClick={(event) => deleteClickHandler(event)} className='file__btn file__delete'><img src={deleteBtn}
                                                                                                         alt=""/>
          </button>
        </div>
      );
